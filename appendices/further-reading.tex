...
\begin{itemize}
    \item Constance Reid, \textit{Hilbert}, Springer-Verlag, 1970. A classic biography of David Hilbert, highly readable and engaging.

    \item Jeremy Gray, \textit{The Hilbert Challenge}, Oxford University Press, 2000. A comprehensive history of Hilbert's problems and their influence on 20th-century mathematics.

    \item Barry Mazur, ``The Hilbert Problems,'' in \textit{Mathematics: Frontiers and Perspectives}, AMS, 2000. An essay on the philosophical significance of Hilbert's problems.
\end{itemize}
...
\begin{itemize}
    \item Michael Artin, \textit{Algebra}, Pearson, 2011. An excellent undergraduate algebra text covering group theory, rings, and Galois theory.
    ...
    \item Miles Reid, \textit{Undergraduate Algebraic Geometry}, Cambridge University Press, 1988. A gentle introduction to the geometry underlying Problems 14--16.
\end{itemize}

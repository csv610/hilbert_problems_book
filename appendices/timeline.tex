...
\begin{description}
    ...
    \item[1788] Lagrange writes \textit{M\'ecanique Analytique}, founding the calculus of variations (Problems 20, 23).
...
\begin{description}
    ...
    \item[1910] Formalin: Russell and Whitehead's \textit{Principia Mathematica} (related to Problem 2).
...
\begin{description}
    ...
    \item[2026] The Langlands program continues to be one of the most active areas of mathematical research.
\end{description}

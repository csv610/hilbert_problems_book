...
In the mid-nineteenth century, Bernhard Riemann introduced a revolutionary idea: to study complex-analytic functions not on flat subsets of the complex plane, but on \emph{curved surfaces} on which a complex structure could be defined. These objects, later named \textbf{Riemann surfaces} in his honor, arose naturally as the natural domains of multivalued functions such as $w = \sqrt{z}$ or $w = \log z$.

Riemann's great achievement was his \emph{mapping theorem}, which he announced in his 1851 doctoral dissertation:
...
The resolution of Hilbert's Problem~22 is the following magnificent theorem, due independently to Koebe and Poincar\'e.
...
The uniformization theorem is one of the crown jewels of complex analysis and geometry, with deep connections across mathematics:
...
\begin{enumerate}
    ...
    \item \textbf{Algebraic geometry.} Every compact Riemann surface is the same thing as a smooth projective algebraic curve over $\mathbb{C}$. Uniformization thus gives a deep connection between complex analysis, hyperbolic geometry, and algebraic geometry.
